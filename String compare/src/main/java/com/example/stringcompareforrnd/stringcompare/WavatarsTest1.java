 ...
 */
public class WavatarsTest1 extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v == yesBtn || v == noBtn){
            ...
            if(v == yesBtn)
                shareEdit.putBoolean("wavTest1Result",false);
            else
                shareEdit.putBoolean("wavTest1Result",true);
            Calendar c = Calendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss a");
            String strDate = sdf.format(c.getTime());
            shareEdit.putString("wavatarTest1EndTime",strDate);
            shareEdit.putString("wavatarTest2StartTime",strDate);
            shareEdit.commit();
            Intent startIntent = new Intent(WavatarsTest1.this,WavatarsTest2.class);
